...
full_logo: true
title: Butterfly FAQ
subtitle: Butterfly Jewelry That Moves
description: Animated Butterfly Jewelry
permalink: /butterfly/faq
sitemap:
  priority: 1.0
---

<figure style="text-align: center; max-width: 1000px; margin: 0 auto; display: block;">
  <video controls muted autoplay loop style="display: block; width: 100%; height: auto; max-width: 100%;">
    <source src="/assets/video/butterfly/bell_jar.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
  <figcaption style="font-style: italic; margin-top: 12px; color: #666;">
...
- Secondly, it's bloody difficult. Getting something tiny to lift its own weight is tough. The battery would have to big, which adds weight, which means you'd need a bigger battery to give the power to lift that weight, and a bigger battery adds _more_ weight, etc, et bloody cetera.
...
### Does It _Really_ Move Like A Butterfly?

In short, it probably moves like _you_ think a butterfly moves, more or less.

- Most people's images of butterflies are [_dead butterflies_](https://www.emilydamstra.com/please-enough-dead-butterflies/). So that's what my butterfly looks like. Like the mental image of a living butterfly to _most_ humans. ([Lepidopterists](https://en.wikipedia.org/wiki/Lepidopterology), I'm happy to make custom versions, just so I can be scientifically accurate for once in this mad scheme).
- It has two wings, not four. If you look at most depictions of butterflies, this is what they use.
- Humans tend to like regularity. Butterflies have an element of randomness in their flap. But if a machine moves just a little bit randomly, it looks weird, like you're looking at a clock with a crazy rhythm.

_Note: I can happily build in randomization, and that may be an option in future. The four-wing movement might be trickier_

### How Did You Get The Skills To Make It?

Trial and error. A _lot_ of trial and error. And learning from my friends at [hackerspaces](https://en.wikipedia.org/wiki/Hackerspace).

### I Don't Like Butterflies. Can You Make Me _XXX_?

If it flaps I can probably make it. Dragons, angels, birds, bats. Uh, sea turtles, since I guess they "fly" underwater". If it's a flippity-flappity thing you want, I can probably make it.
...
To the first two, Hell no. For IoT, Bluetooth, wifi, I suppose they _could_ be options, but I can't really see a use case at the moment.
...
### Do You Have More Pictures Or Videos?
